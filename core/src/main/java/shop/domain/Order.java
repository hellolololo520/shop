...
public class Order {
    ...
    public static void sendNotification(InventoryInsced inventoryInsced) {
        ...
        */
        ...
        repository().findById(inventoryInsced.get???()).ifPresent(order->{
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void statuschange(DeliveryCanceled deliveryCanceled) {
        //implement business logic here:
