...
pluralCaseList.push( {plural: "cores/orders", pascal: "CoreOrder"} )

pluralCaseList.push( {plural: "sups/deliveries", pascal: "SupDelivery"} )
pluralCaseList.push( {plural: "sups/inventories", pascal: "SupInventory"} )
